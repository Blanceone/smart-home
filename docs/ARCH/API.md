...
| v1.2     | 2026-03-24 | 架构师 | 适配PRD v1.2：新增日志上传接口 |
...
| `X-Device-ID` | 否 | 设备标识，用于限流统计和日志关联 |
...
| 40001 | 日志文件过大 | 超过5MB限制 |
| 40002 | 日志格式错误 | 日志数据格式不正确 |
| 40003 | 日志上传失败 | 服务端存储失败 |
...
```json
{
  ...
  "message": "success",
  "data": {
    "uploadId": "upload_20260324_001",
    "receivedAt": "2026-03-24T10:30:45.123Z",
    "logCount": 1523,
    "status": "received"
  }
}
...
| v1.2 | 2026-03-24 | 适配PRD v1.2：新增日志上传接口 | 架构师 |
